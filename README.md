...
If you want to check quickly how Talaiot help us you need to populate the data. We are providing script to populate data based in [this](https://github.com/cdsap/TalaiotClientExample) 
example repository.
